...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <section class="ftco-section">
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-md-6 col-lg-3 ftco-animate" style="position: relative;">  <!-- Added inline style -->
    				<div class="product">
						...
						<div class="hover-cart" ><a class="ADC"   href="./cart.php">add to cart</a></div> <!--1st add to cart-->
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
						...
						<div calss="hover-cart"><a class="ADC mb-4"   href="./cart.php">add to cart</a></div> <!-- add to cart-->
    					<div class="text py-3 pb-4 px-3 text-center">
